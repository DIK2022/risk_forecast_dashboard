...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    loader_requested = Signal(str) # путь к файлу
    ...
    def __init__(self):
        ...
        self.combo_method.currentTextChanged.connect(self.method_chaged.emit)
        ...
        self.slider_alpha.setRange(5, 95)
    ...
    def on_load_clicked(self):
        path, _ = QFileDialog.getOpenFileName(self, "Выбирете CSV", "", "CSV files (*.csv)")
        if path:
    ...
    def update_table(self, dataframe):
        ...
        class PandasModel(QAbstractTableModel):
            ...
            def rowCount(self, pare=QModelIndex()):
    ...
    def plot_series(self, x, y, color='b', name=''):
        self.graph_widget.plot(x, y, pen=colot, name=name)
